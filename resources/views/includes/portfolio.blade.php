                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <h2 class="mb-0 portfolio-modal-title text-secondary text-uppercase" id="portfolioModal1Label">{{ $portfolio->title }}</h2>
                            <!-- Icon Divider-->
                            ...
                            <img class="mb-5 rounded img-fluid" src="{{ asset($portfolio->image) }}" alt="" />
                            <!-- Portfolio Modal - Text-->

                            <p class="mb-5">{{ $portfolio->desc }}</p>
                            <div class="flex-row mb-5 d-flex justify-content-around">
                                <a href="{{ $portfolio->git }}" target="_blank" class="btn btn-secondary"> <i class="fas fa-code-branch"></i> Codigo fuente </a>
                                <a href="{{ $portfolio->demo }}" target="_blank" class="btn btn-info"> <i class="fas fa-eye"></i> Demo</a>
                            </div>
